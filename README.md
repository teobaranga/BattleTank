...
**Last completed lecture:** A Better Component Architecture (60/113)
...
- Basic movement functionality: forwards/backwards (NOTE: movement is glitchy at this stage possibly due to the tank collision volumes)
