...
**Last completed lecture:** Introducing Particle Systems (99/114)
...
- Aiming and firing projectiles, along with muzzle flash and smoke trails done using particle effects 
