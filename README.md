...
**Last completed lecture:** Dissecting `RequestDirectMove()` (63/113)
...
- Basic movement functionality: forwards/backwards, left/right (NOTE: movement is glitchy at this stage possibly due to the tank collision volumes)
- NavMesh
